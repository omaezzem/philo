...
/*   Updated: 2025/03/22 09:33:14 by omaezzem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/philo.h"

void ft_init_philosophers(t_dining_table *table)
{
    int i;
...
int ft_init_mutex_forks(t_dining_table *table)
{
    int i;
